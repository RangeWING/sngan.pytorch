...
class Generator(nn.Module):
    def __init__(self, args, activation=nn.ReLU(), n_classes=0):
        ...
        self.block5 = GenBlock(self.ch, self.ch, activation=activation, upsample=True, n_classes=n_classes)
...
class Discriminator(nn.Module):
    def __init__(self, args, activation=nn.ReLU()):
        ...
        self.block5 = DisBlock(args, self.ch, self.ch, activation=activation, downsample=False)
